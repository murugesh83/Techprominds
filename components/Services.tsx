              ...
              <div className="p-12 relative">
                ...
                <div className="flex flex-wrap gap-3 mb-12">
                  {service.features.map((feature, idx) => (
                    <span key={idx} className="px-4 py-2 rounded-lg bg-blue-50 text-primary text-xs font-bold uppercase tracking-widest border border-blue-100">
                      {feature}
                    </span>
                  ))}
                </div>
                
                <button className="w-full py-5 bg-primary text-white font-black rounded-xl hover:bg-primary-dark transition-all text-lg tracking-widest uppercase shadow-lg shadow-primary/25 active:scale-95">
                  Schedule Call
                </button>
              </div>
            </div>
